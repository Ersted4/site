...
<head>
    ...
    <?= Html::csrfMetaTags() ?>
    <link rel="shortcut icon" href="/1.jpg" type="image/jpg">
        ...
        <div class="row">
            <div class="col-md-4">
                <aside class="footer-widget">
                    <div class="about-img"><img src="/public/images/logo.jpg" alt=""></div>
                    <div class="about-content">
                    </div>
                    <div class="address">
                        <h4 class="text-uppercase">Контактная информация:</h4>

                        <p> 11111/11 ТТ ТТТТТТТ, ТТ, ТТ</p>

                        <p> Phone: +111 111 11111</p>
